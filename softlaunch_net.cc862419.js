function e(e){return e&&e.__esModule?e.default:e}var t={};t=import.meta.resolve("2ihdW");var a={};a=import.meta.resolve("6HHxK");var s={};s=import.meta.resolve("6WMuG");var i={};i=import.meta.resolve("jkK5m");var o={};o=import.meta.resolve("5AiS1");var r={};r=import.meta.resolve("vWF3t");var n={};n=import.meta.resolve("cGiDC");var l={};l=import.meta.resolve("3enmG");var c={};c=import.meta.resolve("7pBuk");var d={};d=import.meta.resolve("9ssh9");var p={};p=import.meta.resolve("4hG6Y");var h={};h=import.meta.resolve("iqIBc");var m={};m=import.meta.resolve("2JypZ");var u={};u=import.meta.resolve("6CY85"),window.scrollToSection=function(e){let t=document.getElementById(e);t&&t.scrollIntoView({behavior:"smooth"})},document.addEventListener("DOMContentLoaded",()=>{let v;document.getElementById("app").innerHTML=`
    <header class="site-header">
      <div class="header-content">
        <div class="header-left">
          <img src="${e(d)}" alt="Cloud" class="cloud-icon">
    ...
    <div class="landing-container">
      <section class="content-section intro-section">
        <div class="intro-content">
          <img src="${e(p)}" alt="Workshop introduction" class="intro-image">
      ...
      <section class="workshops-container">
        <div class="workshops-grid">
          ...
          <article class="workshop-box">
            <img src="${e(h)}" alt="Net Art Workshop" class="workshop-image">
            <div class="workshop-content">
              <h2>Net Canvas</h2>
              <h3 class="workshop-subtitle">Creative Coding with the Browser</h3>
              <p class="workshop-description">Code your own net art using the web as both medium and canvas. Over two days, you'll learn the fundamentals of web development\u{2014}HTML, CSS, and JavaScript\u{2014}while exploring how artists use browsers, networks, and user interaction as creative tools. We'll cover hosting websites, updating them with GitHub, and making them responsive to the broader internet. You'll experiment with creative coding libraries and understand the historical context of net art from early new media pioneers to today's practitioners. Leave with several portfolio-ready projects and the skills to continue building your online practice.</p>
          ...
          <article class="workshop-box">
            <img src="${e(m)}" alt="TouchDesigner Workshop" class="workshop-image">
            <div class="workshop-content">
          ...
          <article class="workshop-box">
            <img src="${e(u)}" alt="Synthetic Worlds Workshop" class="workshop-image">
            <div class="workshop-content">
          ...
          <div class="beyond-classroom-carousel">
            ...
            <div class="carousel-track">
              <div class="carousel-item active">
                <img src="${e(t)}" alt="Projecting the Future workshop" class="carousel-image">
              ...
              <div class="carousel-item">
                <img src="${e(a)}" alt="BioSonification at MOCA" class="carousel-image">
                <p class="carousel-caption">BioSonification installation at MOCA - data-driven sound art</p>
                <p class="carousel-credit">Photo credit: Tosca Ter\xe1n (2019)</p>
              </div>
              <div class="carousel-item">
                <img src="${e(s)}" alt="Open Studio event" class="carousel-image">
              ...
              <div class="carousel-item">
                <img src="${e(i)}" alt="Interactive installation" class="carousel-image">
      ...
      <section class="content-section">
        ...
        <div class="team-grid">
            <div class="team-member">
              <img src="${e(o)}" alt="Tara Rose Morris" class="team-photo">
              <div class="team-info">
            ...
            <div class="team-member">
              <img src="${e(r)}" alt="Benjamin Lappalainen" class="team-photo">
              <div class="team-info">
  ...
  `;let g=null;g=window.supabase.createClient("https://kwgxwzywmcslyqvqtzue.supabase.co","sb_publishable_FWrAeJdYCQ7fCIeviahVYw_wOrhPjkB");let w=document.querySelector(".signup-form");w&&w.addEventListener("submit",async function(e){e.preventDefault();let t=new FormData(this),a=t.get("name"),s=t.get("email");if(!a||!s)return void alert("Please fill in both name and email fields.");if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(s))return void alert("Please enter a valid email address.");let i=this.querySelector(".signup-button"),o=i.textContent;i.textContent="Adding to list...",i.disabled=!0;try{if(g){let{data:e,error:t}=await g.from("email_signups").insert([{name:a.trim(),email:s.trim().toLowerCase()}]);t?"23505"===t.code?alert("This email is already on our list!"):(console.error("Supabase error:",t),alert("There was an error adding you to our list. Please try again.")):(alert(`Thank you ${a}! We'll keep you updated at ${s}.`),this.reset())}else alert(`Thank you ${a}! We'll keep you updated at ${s}.`),this.reset()}catch(e){console.error("Error:",e),alert("There was an error adding you to our list. Please try again.")}finally{i.textContent=o,i.disabled=!1}});let y=0,f=!1,b=document.querySelectorAll(".carousel-item"),k=document.querySelectorAll(".indicator");function A(e){f||(f=!0,b.forEach(e=>e.classList.remove("active")),k.forEach(e=>e.classList.remove("active")),b[e]&&(b[e].classList.add("active"),k[e].classList.add("active")),y=e,setTimeout(()=>{f=!1},500))}function I(){f||A((y+1)%b.length)}function S(){v=setInterval(I,5e3)}k.forEach((e,t)=>{e.addEventListener("click",()=>{f||(v&&clearInterval(v),A(t),S())})}),b.length>0&&S(),document.querySelectorAll(".register-button.disabled").forEach(e=>{e.addEventListener("click",e=>{e.preventDefault()})})});
//# sourceMappingURL=softlaunch_net.cc862419.js.map
